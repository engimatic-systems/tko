...
#+begin_example
require TKO_* writes
update existing top-level drawer entry when present
insert drawer or missing property when absent
#+end_example
...
lint help mentions note-title lint surface
#+end_example
